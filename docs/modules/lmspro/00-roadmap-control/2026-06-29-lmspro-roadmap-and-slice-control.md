...
| [`CR-Fix-2026-08-11-lmspro-free-day-owner-notice-authority.md`](../01-cr-inputs/CR-Fix-2026-08-11-lmspro-free-day-owner-notice-authority.md) | Complete green local smoke; R12-A `39a25d99` is retained in exact control-owner-accepted staging head `cde4eaff`, now aligned through main with all exact scans and public health green | Production branch inclusion complete by ancestry; retain its bounded evidence and confirm current Render production identity with the combined release |
