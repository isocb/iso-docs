...
| [`CR-Fix-2026-08-05-lmspro-cohort-email-draft-persistence-and-audience-selection.md`](../01-cr-inputs/CR-Fix-2026-08-05-lmspro-cohort-email-draft-persistence-and-audience-selection.md) | F1 PASS; F2 superseded; F2.1/F2.2 delivered in `83356030` ancestry; F3 implemented and automated-reviewed at local application `72c02d92`; no schema/migration; staging human smoke pending | F3 uploaded-file-only acknowledgement remains portfolio `Now`; dev/staging promotion and the human gate are authorised; production remains blocked |
