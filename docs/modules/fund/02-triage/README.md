...
This folder contains decision documents created from CR inputs.

Triage documents classify issues into:
...
Triage documents should identify blocker status, suggested branch/slice and whether clarification is needed before implementation.
