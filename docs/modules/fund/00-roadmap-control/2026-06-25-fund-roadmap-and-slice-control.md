...
workflow gates. Corrected candidate `8bda74f4` implements the correction. Its guarded Neon DevData
...
| Item | Status | Control |
| --- | --- | --- |
| Application repository | Primary local checkout runs corrected B1-R1 candidate `8bda74f4` on `work/fund-b1-r1-catalogue-workflow`; dev/staging/main unchanged | Retry Intake creation and Catalogue assignment; publish only with the required authority; remaining High-control proof and human acceptance precede promotion |
