...
Next human decision/test: A0/A/B VAT PASS retained; C/publication smoke paused. Chris directs simplicity and demonstrable results. The launch-preparation plan has been replaced on 17 September with producer defaults, optional Event ladders, automatic images and one launch confirmation. Chris has answered the commission/editing tradeoffs: fix terms at start/launch, default all eligible Products, optional removal before finalisation, no unlock. Public selling dependencies remain. No new implementation selected; B1 Now / 1R-G planning Next unchanged. Do not ask for another unavailable publication test. Separate review/promotion remain outstanding; no live FUND approval.
Safe resumption point: use B1-R3 04/05 evidence at 6ebaac46 and the replacement launch plan; preserve user comments and the test bed. Implement the supported preparation journey only after selection; historical C5 proposal/acceptance UX is superseded, not a backlog to reproduce. Real artwork release/public Store/purchasing remain dependencies. No fixture writes inferred; old wf1 stays archived.
```
