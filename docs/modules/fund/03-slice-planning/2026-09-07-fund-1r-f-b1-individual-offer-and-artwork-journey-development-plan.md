...
```text
Current state: simple Store preparation locally committed at 9c09cbe1 (application behaviour 3820e304). Build/type/verify/changed-source lint and 601 unit tests PASS. New connected preparation, B1-R3/frozen-PDF and eight Catalogue cases PASS; oversized remaining regression deliberately interrupted after Chris challenged the delay. Chris records local preparation smoke 1–5 PASS on 17 September. Separate review, remaining regression and promotion are open; B1 is not closed.
Last proven commit: 9c09cbe1a9f822ccadde122e1680ab8e513ef9e1 has the bounded evidence in the 17 September 04/05 records; not a whole-run/A7 PASS. Earlier 6ebaac46 retains its historical B1/B1-R3/A7 proof and A0/A/B human VAT PASS. Last recorded staging remains e7e8837c.
Current environment: local work/fund-b1-r3-platform-vat at 9c09cbe1; not pushed or consolidated into dev. No new migration/application data/environment change; DevData remains 157 and old wf1 remains archived. Dedicated test database removal and absence verified. Online dev/staging remain e7e8837c; main/live remains 0397bba9 as previously recorded.
Next human decision/test: local preparation smoke 1–5 is PASS in 2026-09-17-fund-simple-store-preparation-review-and-test.md; no repeat requested. Keep VAT A0/A/B PASS. Development PDF is not classroom-ready artwork; public publication/purchase smoke stays paused until release capabilities exist. Separate review must assess/finish the explicitly remaining regression before promotion.
Safe resumption point: preserve the completed C1-to-C2 preparation demonstration and finish the outstanding technical review; use focused checks for unresolved risks rather than repeating the whole remote suite without cause. Preserve first-publication commission locking, pre-opening preparation, finalised evidence and the local test bed. B1 Now / 1R-G planning Next unchanged; no promotion authorised here.
```
