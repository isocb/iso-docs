...
- [B1-R3 Product VAT rate authority CR-Fix](CR-Fix-2026-09-16-fund-product-vat-rate-authority.md) — 2026-09-16: triaged/planned inside B1; implementation not started; revised smoke is pending the corrected candidate.
