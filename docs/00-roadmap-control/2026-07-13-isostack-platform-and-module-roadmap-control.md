...
```text
R14-A corrected exact local 0a6376a2 automated gate and direct R1-R6 PASS; public role-name child 66104e35 automated/direct R7 PASS; responsive row-click modal child b6c35992 focused 2/2 plus type/verify/lint/whitespace PASS; R8 NOT RUN
...
| --- | --- | --- |
| **NOW** | LMSPro R14-A Team Variation approval guidance and configured inputs CR-Fix | Corrected exact local `0a6376a2` passes its automated gate and direct R1-R6; role-name child `66104e35` passes automation/direct R7; responsive row-click modal child `b6c35992` passes its focused automated delta and R8 remains `NOT RUN`. No push, promotion or deployment authority. |
...
`League Admin` and passes R7. Responsive row-click modal child `b6c35992` passes automation and awaits R8. Preserved FUND
...
- LMSPro Free Day and Team Variation Request remediation `CR-Fix`: accepted on 2026-08-24
  ...
  `0a6376a2` passes automation and direct R1-R6, role-name child `66104e35` passes R7, and responsive
  row-click modal child `b6c35992` awaits R8; it does not automate Age Group/Division allocation;
