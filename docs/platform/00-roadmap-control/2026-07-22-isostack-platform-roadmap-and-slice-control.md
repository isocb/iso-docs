...
| [`CR-Fix-2026-08-17-isostack-platform-plat-role-04a-seasonpro-incomplete-user-discoverability-and-activation.md`](../01-cr-inputs/CR-Fix-2026-08-17-isostack-platform-plat-role-04a-seasonpro-incomplete-user-discoverability-and-activation.md) | C1 repair inventory, separate derived module state and direct/bulk complete-persona activation gate are delivered in exact `fcd162db`; local and staging-applicable human/automated gates pass | Exact `fcd162db` is live through main; all three scans, Render identity and health pass. Portfolio `Now` is the minimum production smoke; FUND Stage C remains `Next` |
...
- `CR-Fix-PLAT-ROLE-04A` separately implements C1 discoverability and activation gating for
  ...
  scans, staging/production Render identity, health and staging-applicable human checks
  green; exact `fcd162db` is live through main and its minimum production smoke is `Now`;
