...
- `CR-Fix-PLAT-ROLE-04A` separately implements C1 discoverability and activation gating for
  ...
  scans, Render identity, health and staging-applicable human checks green; its main decision is `Now` and it
