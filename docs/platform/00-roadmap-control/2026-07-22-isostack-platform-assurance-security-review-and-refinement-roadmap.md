...
| `PLAT-ASSURE-05` | Next.js, Sharp And js-yaml Security Remediation | Critical/High dependency and shared runtime correction | Accepted security interrupt | Exact `0397bba9` published through dev/staging; audit/regression/runtime proof PASS; main/live on hold for independent review, staging acceptance and specific approval |
