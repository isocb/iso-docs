...
| `PLAT-ASSURE-04` | Fast-URI Dependency Advisory Remediation | New High dependency advisories blocking all protected branches | Urgent accepted expedite | Exact `14077382` aligned through staging; 0 High/Critical and all technical gates pass; exact Render identity/H1-H4 pending; main prohibited |
| `PLAT-ASSURE-04-R1` | September Moderate/Low Dependency Assessment | TipTap major migration plus qs, humanfs, sanitize-html and selector-parser findings | Standard follow-up | Recorded separately; must not enlarge or delay the High incident-ending correction |
