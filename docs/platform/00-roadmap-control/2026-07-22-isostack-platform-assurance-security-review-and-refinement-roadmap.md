...
| `PLAT-ASSURE-04` | Fast-URI Dependency Advisory Remediation | New High dependency advisories blocking all protected branches | Urgent accepted expedite | Exact `14077382` aligned through main; all scans, staging H1-H4 and production health PASS; production Render identity pending closure |
