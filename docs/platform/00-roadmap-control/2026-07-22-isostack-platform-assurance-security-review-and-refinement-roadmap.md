...
| `PLAT-ASSURE-04` | Fast-URI Dependency Advisory Remediation | New High dependency advisories blocking all protected branches | Urgent accepted expedite | Exact 3.1.7-only correction authorised through staging; main prohibited pending staging evidence/human gate |
